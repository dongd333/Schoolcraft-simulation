...
!********************************************************************************************************************
  ...
  private
  public :: linear_sorption_cl                !classes
  public ::                           &       !methods
  ...
  subroutine delete_linear_sorption_ (this) !destructor
	 ...
	 type(linear_sorption_cl), intent(inout) :: this
  ...
  function inquire_homogeneity_linear_sorption_ (this) result (flag)
	  ...
	  type(linear_sorption_cl), intent(in)   :: this
	  logical                                :: flag
...
!********************************************************************************************************************
  ...
  subroutine delete_CHTM_ (this) !destructor
	 ...
	 type(CHTM_cl), intent(inout) :: this
...
!*********************************************************************************************************************
  ...
  public ::                                    &       !methods
       ...
       type sorption_cl
	       ...
	       type(linear_sorption_cl),  pointer     :: LinearSorption => null()
	       type(CHTM_cl),  pointer                :: CHTM => null()
       end type
