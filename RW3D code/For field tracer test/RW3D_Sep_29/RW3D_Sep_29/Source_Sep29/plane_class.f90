...
!*****************************************************************************************************   
	...
	type plane_cl
		 real*8                         :: xplane=0.d0,yplane=0.d0            !Position of a plane
    ...
    interface assign_plane_
	     module procedure assign_plane_xxORyy, assign_plane_general; end interface
	...
	subroutine assign_plane_xxORyy (name,a,typ,flag,curve)      !old plume constructor for planes parallel and perpendicular to x,y
	     use breakthru_class
    ...
    subroutine read_assign_plane_ (name,iunit)
		 ...
		 integer                        :: flag
		      ...
		      backspace(iunit)
		      if (oldinput) then
	              read(10,*) dist,tipo,flag;  call assign_plane_xxORyy (name,dist,tipo,flag)
