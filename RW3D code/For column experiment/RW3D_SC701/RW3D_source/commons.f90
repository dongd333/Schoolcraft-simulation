...
!*************************************************************************************
  module global_variables
	 ...
	 integer,            parameter      :: nfnam = 15, nmaxmove = 10000000, iwscreen = 1
	 character(len=200), parameter      :: fdbg = 'rw3d.dbg'
     character(len=200), parameter      :: version='6.0',date='19 NOV 2015'
	 ...
	 real*8                             :: courant,peclet,DaKINETIC,DaDECAY,DaMMT    !Grid courant and peclet number, Damkholer number 
	 ...
	 !integer                            :: seed(2)
	 !data                                  seed /987654321, 123456789/
	 integer*4                          :: seedzone = 987654321
	 !integer*4                          :: seedbimo = 987654321
