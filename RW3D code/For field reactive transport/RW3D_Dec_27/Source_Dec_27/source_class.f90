...
!	-------------------------------------------------------------------------------------- 			     
    ...
    subroutine read_source_ (this,namein,TypeInjIn,fname)
       ...
       integer,allocatable                  :: ix(:),iy(:),iz(:)
           ...
           if (this%typeInj == 'DEPENDENT') then
              read(unit,*) file,const
              call read_timefunction_ (file,const,1,this%timefunct)
              this % freq = 1
              do it=1,this%timefunct%nt
...
!	-------------------------------------------------------------------------------------- 			     
    ...
    subroutine print_source_ (this,fname)
       ...
       integer                              :: unit
           ...
           elseif ( trim(adjustl(name)) == 'QX_FLUX_WEIGHTED' ) then
                   ...
                   if (this%TypeInj == 'DEPENDENT') call print_time_function_ (fname,this%timefunct)    
