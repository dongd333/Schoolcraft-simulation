...
C--------------------------------------------------------------------------      
      If(ISOTHM .EQ. 0) Then
          ...
          Do 71   K=1,NLAY
              If (K .LE. 15) then
                  KD = 1.45E-07
                  RCT(K) = 1.0 + RHO*KD*FRAC/POR
              Elseif ((K .GE. 15) .AND. (K .LE. 28)) then
                  KD = 1.65E-07
                  RCT(K) = 1.0 + RHO*KD*FRAC/POR
              Else
                  KD = 3.57E-07
              ...
              Do 81   I=1,NROW
                  do 91   J=1,NCOL
                      DO 991  index = 1,mcomp
                          If (ICBUND(J,I,K,index) .EQ. 0) goto 91
                          RETA(J,I,K,index) = 1.0
                          RETA(J,I,K,1) = RCT(K)
                          RFMIN = min(RFMIN,RETA(J,I,K,index))
991                   Continue
91                Continue
81            Continue
71        Continue
